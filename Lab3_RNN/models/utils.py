...
def parse_args():
    ...
    parser.add_argument('--reload', action='store_true', help="Reload preprocessed data")
    ...
    parser.add_argument('--learning_rate_embed', type=float, default=-1, help="Learning rate for embedding layer")
