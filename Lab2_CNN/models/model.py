...
#         labels_t = self.labels_t # all labels
#         image_names = self.image_names # train image names
#         val_labels = RawData.val_labels() # val labels
#         val_names = self.val_names # val image names
...
#             image = np.array(image).reshape(64, 64, 3) # Shape: (64, 64, 3)
