...
python train.py -r /data2/wrz/Datasets/ --dataset cora --task node-cls -lr 0.01 -n 200 --patience 50 --hidden-dim 128 -nl 2 --self-loop --tag self-loop-relu --activation relu

# Citeseer Node Classification: 0.7230
python train.py -r /data2/wrz/Datasets/ --dataset citeseer --task node-cls -lr 0.01 -n 200 --patience 50 --hidden-dim 128 -nl 2 --self-loop --tag self-loop-relu --activation relu

# PPi Node Classification: 0.7438
python train.py -r /data2/wrz/Datasets/ --dataset ppi --task node-cls -lr 0.02 -n 200 --patience 100 --hidden-dim 256 -nl 2 --self-loop --tag self-loop-relu --activation relu

echo "=== Link Prediction ==="
# Cora Link Prediction: 0.6973
python train.py -r $root --dataset cora --task link-pred -lr 0.01 -n 200 -ws 10 --patience -1 --scheduler cosine --hidden-dim 128 -nl 2 --self-loop --tag self-loop-relu --activation relu
