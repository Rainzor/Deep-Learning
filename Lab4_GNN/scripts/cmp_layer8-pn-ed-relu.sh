...
python train.py -r /data2/wrz/Datasets/ --dataset cora --task node-cls -lr 0.01 -n 200 --patience 50 --hidden-dim 128 -nl 8 -pn PN-SI --edge-drop 0.1 --tag l8-pn-ed-relu --activation relu

# Citeseer Node Classification: 0.7230
python train.py -r /data2/wrz/Datasets/ --dataset citeseer --task node-cls -lr 0.01 -n 200 --patience 50 --hidden-dim 128 -nl 8 -pn PN-SI --edge-drop 0.1 --tag l8-pn-ed-relu --activation relu

# PPi Node Classification: 0.7438
python train.py -r /data2/wrz/Datasets/ --dataset ppi --task node-cls -lr 0.02 -n 200 --patience 100 --hidden-dim 256 -nl 8 -pn PN-SI --edge-drop 0.1 --tag l8-pn-ed-relu --activation relu
